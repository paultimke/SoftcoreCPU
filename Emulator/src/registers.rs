...
impl Registers {
    ...
    pub fn print(&self) -> () {
        println!("\r{}", "General Purpose Registers:".bold());
        println!("\rREG  SIGNED UNSIGNED HEX   |  REG  SIGNED UNSIGNED HEX");
        println!("\rr0:  {r0:<7}{ru0:<8} {r0:04X}  |  fp:  {r4:<7}{ru4:<9}{r4:04X}", 
                  r0=self.gp[0], ru0=(self.gp[0] as u16), r4=self.gp[4], ru4=(self.gp[4] as u16));
        println!("\rr1:  {r1:<7}{ru1:<8} {r1:04X}  |  sp:  {r5:<7}{ru5:<9}{r5:04X}", 
                  r1=self.gp[1], ru1=(self.gp[1] as u16), r5=self.gp[5], ru5=(self.gp[5] as u16));
        println!("\rr2:  {r2:<7}{ru2:<8} {r2:04X}  |  lr:  {r6:<7}{ru6:<9}{r6:04X}", 
                  r2=self.gp[2], ru2=(self.gp[2] as u16), r6=self.gp[6], ru6=(self.gp[6] as u16));
        println!("\rr3:  {r3:<7}{ru3:<8} {r3:04X}  |  mbr: {r7:<7}{ru7:<9}{r7:04X}", 
                  r3=self.gp[3], ru3=(self.gp[3] as u16), r7=self.gp[7], ru7=(self.gp[7] as u16));

        println!("\r{}", "\nSpecial Purpose Registers:".bold());
        println!("\rpc:  {pc:<7}{pcu:<8} {pc:04X}", pc=self.pc, pcu=(self.pc as u16));
        println!("\rir:  {ir:<7}{iru:<8} {ir:04X}", ir=self.ir, iru=(self.ir as u16));   
    }
}